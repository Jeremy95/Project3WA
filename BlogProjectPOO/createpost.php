...
if(array_key_exists("content", $_POST) && array_key_exists("idUser", $_POST) && array_key_exists("title", $_POST) && array_key_exists("picture", $_FILES))
{

    if(isset($_FILES) && sizeof($_FILES["picture"]["name"]) > 1)
    {
